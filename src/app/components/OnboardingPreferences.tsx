...
const CATEGORIES = [
  ...
  { id: "tv-audio", label: "TV & Audio", icon: Tv },
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      {step === 3 && (
        <div className="flex-1 flex flex-col items-center justify-between px-6 pb-10">
          <div className="flex-1 flex flex-col items-center gap-12 text-center">
            <div className="relative flex items-center justify-center">
              <img src="/evomag-poc/onboarding_preferences_robot.png" alt="EvoMi Robot" className="w-[250px] object-contain" />
            </div>
            <div>
